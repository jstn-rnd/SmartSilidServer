# Generated by Django 5.1 on 2024-11-16 04:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField(default=datetime.date(2024, 11, 16))),
                ('scan_time', models.TimeField(default='12:43:15')),
                ('schedule', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='server_app.schedule')),
            ],
        ),
        migrations.CreateModel(
            name='ClassInstance',
            fields=[
                ...
                ('schedule', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='server_app.schedule')),
            ],
        ),
        migrations.CreateModel(
            name='Student',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='server_app.student')),
            ],
        ),
        migrations.CreateModel(
            name='UserLog',
